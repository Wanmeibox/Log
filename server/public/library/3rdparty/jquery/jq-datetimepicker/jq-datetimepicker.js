 ...
 * ========================================================= */
YUI.add("jq-datetimepicker", function(Y){
	var jQuery = Y.jQuery;
	...
	Datetimepicker.prototype = {
		...
		update: function(){
			...
			if(arguments && arguments.length && (typeof arguments[0] === 'string' || arguments[0] instanceof Date)) {
                ...
                date = (this.isInput ? this.element.val() : this.element.find('input').val()) || this.initialDate;
            ...
            if(this.element.data('date') != date && date == DPGlobal.parseDate(date, this.format, this.language, this.formatType)){
...
}, "0.0.1", {requires: ['jquery','jq-datetimepicker-css']});