YUI.add("jq-easyui-combo", function(Y) {
...
//_5.find("input.combo-text").width(_3);
    _5.insertAfter(_2);
if(_5.find("input.combo-text").outerWidth()){
    _4.width = _5.find("input.combo-text").outerWidth()-1;
}
if(_4.width==undefined || _4.width >= _5.find("input.combo-text").outerWidth())
	_4.width = 164;
_6.panel("resize", {
		width : (_4.panelWidth ? _4.panelWidth : _4.width),
...
$("<span style=\"position: absolute;right: 0px;\"><span class=\"combo-arrow\"></span></span>").appendTo(_e);
...
//添加cobot-text触发显示事件
_1b.bind("click.combo-text",function(){
if(_1a.is(":visible")){
_25(_16);
}else{
$("div.combo-panel").panel("close");
...
}, "0.0.1", {requires: ["jquery","jquery-migrate","jq-easyui-combo-css","jq-easyui-validatebox","jq-easyui-panel"]});